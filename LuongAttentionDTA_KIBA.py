...
inDrug = Input(shape=(100,),  dtype='int32') #drugs
inProt = Input(shape=(1200,), dtype='int32') #proteins
...
history=model.fit(x=[X_Drug, X_Prot], y=Y, epochs=2, batch_size=64)
...
viz_model.save("modelo_viz_teste")
